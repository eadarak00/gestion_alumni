...
public class CVCreate {
  ...
  public CVCreate resume(@Nullable String resume) {
    this.resume = resume;
    return this;
  }
  ...
  public CVCreate photo(@Nullable String photo) {
    this.photo = photo;
    return this;
  }
  ...
  public CVCreate linkedin(@Nullable String linkedin) {
  ...
  public CVCreate github(@Nullable String github) {
    this.github = github;
    return this;
  }
  ...
  public CVCreate portfolio(@Nullable String portfolio) {
  ...
  public CVCreate adresse(@Nullable String adresse) {
