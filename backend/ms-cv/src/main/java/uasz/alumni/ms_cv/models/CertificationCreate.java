...
public class CertificationCreate {
  ...
  public CertificationCreate dateObtention(@Nullable LocalDate dateObtention) {
  ...
  public CertificationCreate dateExpiration(@Nullable LocalDate dateExpiration) {
  ...
  public CertificationCreate lienCredential(@Nullable String lienCredential) {
