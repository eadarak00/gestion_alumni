...
public class ExperienceCreate {
  ...
  public ExperienceCreate localisation(@Nullable String localisation) {
  ...
  public ExperienceCreate dateFin(@Nullable LocalDate dateFin) {
  ...
  public ExperienceCreate description(@Nullable String description) {
