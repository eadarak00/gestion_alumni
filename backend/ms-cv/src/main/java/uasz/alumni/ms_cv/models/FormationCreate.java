...
public class FormationCreate {
  ...
  public FormationCreate localisation(@Nullable String localisation) {
  ...
  public FormationCreate dateFin(@Nullable LocalDate dateFin) {
  ...
  public FormationCreate description(@Nullable String description) {
